...
import * as json from './data/cris-s.json';
...
async function bootstrap() {
  ...
  logger.log(
    `Seeding Experian ${ExperianReportTypeEnum.C_RISK_SCORE_INTELLIGENCE} report...`,
  );
  ...
  for (const datum of data) {
    ...
    const experianSeed = new Experian({
      reportType: ExperianReportTypeEnum.C_RISK_SCORE_INTELLIGENCE,

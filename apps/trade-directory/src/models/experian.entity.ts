...
@Entity()
export class Experian extends AbstractEntity<Experian> {
  @ManyToOne(
    () => Organization,
    (organization) => organization.experianReports,
    {
  ...
  @RelationId((experian: Experian) => experian.organization)
  @Column({ nullable: true })
  organizationId: number;

  @ManyToOne(() => Person, (person) => person.experianReports, {
    cascade: ['insert', 'update'],
  })
  person?: Person;

  @RelationId((experian: Experian) => experian.person)
  @Column({ nullable: true })
  personId: number;

  @Column({
    type: 'enum',
    enum: ExperianReportTypeEnum,
    enumName: 'ExperianReportTypeEnum',
  })
  reportType: ExperianReportTypeEnum;

  @Column({
    type: 'enum',
    enum: ExperianReportStatusEnum,
    enumName: 'ExperianReportStatusEnum',
  })
  reportStatus: ExperianReportStatusEnum;

  @Column({
    type: 'enum',
    enum: ExperianReportSourceEnum,
    enumName: 'ExperianReportSourceEnum',
  })
  reportSource: ExperianReportSourceEnum;

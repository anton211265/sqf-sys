...
// Access token lives in memory only — never written to localStorage or a JS-readable
// cookie. Lost on page refresh; re-acquired via silent refresh (see App.tsx).
// Ported from apps/web/src/api/axiosClient.ts — same auth model, same backend.
